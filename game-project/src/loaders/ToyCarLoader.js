    ...
    async loadFromAPI() {
        try {
            ...
            blocks.forEach(block => {
                ...
                // 🚫 Eliminar cámaras y luces embebidas del modelo .glb
                model.traverse((child) => {
                ...
                // 🎯 Manejo de Carteles
                // Aplicar textura al cartel
                const cube = model.getObjectByName('Cylinder001')
                if (cube) {
                    console.log('Cartel encontrado:', cube.name)
                    console.log(cube instanceof THREE.Mesh, cube.visible, cube.material)
                ...
                // 🧵 Integración especial para baked.glb con textura y partículas
